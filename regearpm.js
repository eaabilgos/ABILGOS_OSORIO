...
{
	if (/^[A-Za-z]+$/.test(myFunction.lname.value)) {
		return(true)
	}
...
{
	if (/^[A-Za-z]+$/.test(myFunction.fname.value)) {
		return(true)
	}
	alert("Input letters only")
...
{
	if (/^[A-Za-z.]{1,2}+$/.test(myFunction.midi.value)) {
		return(true)
	}
...
{
	if (/^[0-9]{1,11}+$/.test(myFunction.studno.value)) {
		return(true)
	}
...
{
	if (/^[a-zA-Z][a-zA-Z0-9-_.]{8,15}+$/.test(myFunction.usern.value)) {
		return(true)
	}
...
{
	if (/^[a-zA-Z][a-zA-Z0-9-_.]{8,20}+$/.test(myFunction.psw.value)) {
		return(true)
	}
